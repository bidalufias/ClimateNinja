import type { GameObject, Particle, ScorePopup, ZoneConfig } from '../types/game';
import { pickRandomObject } from './gameObjects';
...
export function createScorePopup(obj: GameObject, combo: number, doublePoints = false): ScorePopup {
  ...
  return {
    ...
    alpha: 1,
    vy: -1.2,
    color: doublePoints ? '#FFD700' : combo > 2 ? '#FFD700' : combo > 1 ? '#FF6B35' : '#4CAF50',
  };
}
